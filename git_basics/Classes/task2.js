...
class Worker extends Human {
    ...
    // greet method
    greet(){console.log('Hello, Worker!')}

    // finish work method
    finishingWork() {console.log('Work is done!')}
    ...
    isWorking() {
        ...
        {console.log(`Worker is not working`)} else if 
        (currentTime >= startTime && currentTime <= finishTime) 
        {console.log(`Worker is working`)} else if (currentTime > finishTime) 
